...
|-----------|-------------|-------|-----------------|-----------|------------------------------------------------------------------------------------|----------|---------------------------------|
| 9442      | 5           | весна | нппнр_ВЕСНА_вапао | —         | *«— Если я не ослышался, вы изволили говорить, что Иисуса не было на свете?»*      | sentence | b1.txt |
| 349271    | 5           | толки | япнон_ТОЛКИ_мпврс | он        | *«.. только вы мне помогите... Она привела его к маленькой двери...»*              | sentence | b1.txt |
